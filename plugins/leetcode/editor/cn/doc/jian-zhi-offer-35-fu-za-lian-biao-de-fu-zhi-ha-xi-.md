...
1. **复制各节点，构建拼接链表:**
    ...
    - 设原链表为 ![node1\rightarrownode2\rightarrow\cdots ](./p__node1_rightarrow_node2_rightarrow_cdots_.png)  ，构建的拼接链表如下所示：

![node1\rightarrownode1_{new}\rightarrownode2\rightarrownode2_{new}\rightarrow\cdots ](./p____node1_rightarrow_node1_{new}_rightarrow_node2_rightarrow_node2_{new}_rightarrow_cdots___.png) 
